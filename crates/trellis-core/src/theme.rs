...
pub mod themes {
    ...
    pub static CLASSIC: Theme = Theme {
        ...
        grid_dot: "#4A8AB5",
        crossing_bg: "#003153",
        crossing_stroke: "#4A8AB5",

        shape_process_fill: "#1B3F6E",
        shape_process_stroke: "#4A8AB5",
        shape_decision_fill: "#1B3F6E",
        shape_decision_stroke: "#4A8AB5",
        shape_terminal_fill: "#1B3F6E",
        shape_terminal_stroke: "#4A8AB5",
        shape_storage_fill: "#1B3F6E",
        shape_storage_top_fill: "#1B3F6E",
        shape_storage_stroke: "#4A8AB5",
        shape_special_fill: "#1B3F6E",
        shape_special_stroke: "#4A8AB5",
        node_text: "#E8F4FB",
        fallback_box_fill: "#1B3F6E",
        fallback_box_stroke: "#4A8AB5",

        edge_stroke: "#4A8AB5",
        edge_fallback_stroke: "#4A8AB5",
        arrow_fill: "#4A8AB5",
        edge_label_text: "#E8F4FB",
        edge_label_bg: "#003153",
        edge_label_border: "#4A8AB5",
        multiplicity_text: "#E8F4FB",
        ...
        er_box_fill: "#1B3F6E",
        er_box_stroke: "#4A8AB5",
        er_entity_text: "#E8F4FB",
        er_attribute_text: "#E8F4FB",

        c4_person_fill: "#1B3F6E",
        c4_person_stroke: "#E8F4FB",
        c4_system_fill: "#1B3F6E",
        c4_system_stroke: "#E8F4FB",
        c4_container_fill: "#1B3F6E",
        c4_container_stroke: "#E8F4FB",
        c4_component_fill: "#1B3F6E",
        c4_component_stroke: "#E8F4FB",
        c4_external_fill: "#003153",
        c4_external_stroke: "#E8F4FB",
        c4_deployment_fill: "#003153",
        c4_deployment_stroke: "#E8F4FB",
        c4_text_on_dark: "#E8F4FB",

        c4_boundary_enterprise_fill: "#003153",
        c4_boundary_enterprise_stroke: "#E8F4FB",
        c4_boundary_system_fill: "#003153",
        c4_boundary_system_stroke: "#E8F4FB",
        c4_boundary_container_fill: "#003153",
        c4_boundary_container_stroke: "#E8F4FB",
        c4_boundary_deployment_fill: "#003153",
        c4_boundary_deployment_stroke: "#E8F4FB",
