...
`01-expectations.md`, gated by approval of a system context diagram.
...
5. **Draft the system context diagram** (`C4Context`) reflecting the agreed
   ...
   `fig-01` in `01-expectations.md`.

6. **Gate**: ask the user to open `01-expectations.md` in VS Code and preview
